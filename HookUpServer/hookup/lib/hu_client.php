<?php
	...
	function HU_dbInsert($data){
		...
		return HU_postRequest(API_URL . "hookup-api.php",json_encode($data),$requestHeader);
	...
	function HU_createUser($name,$email,$password){
		...
		return HU_postRequest(API_URL . "hookup-api.php",json_encode($userData),$requestHeader);
	...
	function HU_createNewsGroup($owner,$groupName,$rss,$groupCategory,$description,$avatar,$thumbnail){

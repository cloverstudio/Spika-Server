<?php
	...
	*/
	...
	$daysToCapture = 30;
	$resultSentPush = executeQuery($DB,"select * from queue where state = " . STATE_SUCCESS . " and sent > '" . date('Y-m-d H:i:s',time() - 60 * 60 * 24 * $daysToCapture) . "' order by sent");
	...
	$resultErrors = executeQuery($DB,"select count(*) as count from queue where state = " . STATE_ERROR . " and queued > '" . date('Y-m-d H:i:s',time() - 60 * 60 * 24 * $daysToCapture) . "' order by sent");
	$errorsCount = $resultErrors[0]['count'];
	$errorRate = sprintf("%.2f",$errorsCount / $overallSent);


	$hoursToCapture = 24;
	$queueStateResult = executeQuery($DB,"select * from queue_state_log where capture_time > '" . date('Y-m-d H:i:s',time() - 60 * 60 * $hoursToCapture) . "' order by capture_time");
	$waitCountResult =  executeQuery($DB,"select * from queue where state = " . STATE_SUCCESS . " and queued > '" . date('Y-m-d H:i:s',time() - 60 * 60 * $hoursToCapture) . "' order by queued");
								...
								<div class="row-fluid margin-top">
									<div class="span4">
										<ul class="pagestats style-3">
											<li>
												<div class="spark">
													<div class="chart" data-percent="<?php echo $cpuUsage ?>" data-color="#f96d6d" data-trackcolor="#fae2e2"><?php echo $cpuUsage ?>%</div>
												</div>
												<div class="bottom">
									...
									<div class="span4">
										<ul class="pagestats style-3">
											<li>
												<div class="spark">
													<div class="chart" data-percent="<?php echo $memoryUsage ?>" data-color="#368ee0" data-trackcolor="#d5e7f7"><?php echo $memoryUsage ?>%</div>
												</div>
												<div class="bottom">
									...
									<div class="span4">
										<ul class="pagestats style-3">
											<li>
												<div class="spark">
													<div class="chart" data-percent="<?php echo $hdUsage ?>" data-color="#56af45" data-trackcolor="#dcf8d7"><?php echo $hdUsage ?>%</div>
												</div>
												<div class="bottom">
						...
						<div class="box box-color box-bordered">
							...
							<div class="box-content">
								<div class="statistic-big">
									<div class="top">
										<div class="right">
											<?php echo number_format($sentToday) ?><span class="small">notifications sent today<span><i class="icon-circle-arrow-up"></i></span>
										</div>
									</div>
									<div class="bottom">
						...
						<div class="box box-color lightred box-bordered">
							...
							<div class="box-content">
								<div class="statistic-big">
									<div class="top">
										<div class="right">
											<?php echo $waitingCount ?> <span class="small">notifications is waiting in queue<span><span><i class="icon-circle-arrow-right"></i></span>
										</div>
									</div>
									<div class="bottom">

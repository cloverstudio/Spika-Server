...
<body class='login'>
<div class="wrapper">
    <h1><a href="index.php"><img src="img/logo-big.png" alt="" class='retina-ready' width="59" height="49">PUSHSrv</a>
    </h1>
            ...
            <div class="control-group <?php echo $additionalFormClass ?>">
                <div class="controls">
                    <input type="text" name='username' value="<?php echo $username ?>" placeholder="User name"
                           class='input-block-level invalid' data-rule-required="true">
                </div>
            </div>
            <div class="control-group <?php echo $additionalFormClass ?>">

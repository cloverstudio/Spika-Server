                    ...
                    <div class="box-content">
                        <form action="#" method="POST" class='form-horizontal'>
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" name="host" id="textfield" value="<?php echo $_POST['host'] ?>"
                                           class="input-xlarge">
                                </div>
                            </div>
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" name="database" id="textfield"
                                           value="<?php echo $_POST['database'] ?>" class="input-xlarge">
                                </div>
                            </div>
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" name="username" id="textfield"
                                           value="<?php echo $_POST['username'] ?>" class="input-xlarge">
                                </div>
                            </div>
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" name="password" id="textfield"
                                           value="<?php echo $_POST['password'] ?>" class="input-xlarge">
                                </div>
                            </div>

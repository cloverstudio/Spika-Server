...
(function() {
    ...
    _chatManager = {
        ...
        templateVoicePost : _.template('<div class="post"><div class="timestamp"><%= time %></div><div class="post_content"><%= body %><br /><audio controls><source src="' + _consts.RootURL + '/api/filedownloader?file=<%= voice_file_id %>" type="audio/wav"><a target="_blank" href="' + _consts.RootURL + '/api/filedownloader?file=<%= voice_file_id %>">Listen voice</a></audio></div></div>'),
